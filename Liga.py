...
class Liga(object):
    ...
    def updateLiga(self):
        ...
        BD().run("update Liga Set Nombre = '"+self.nombre+"', Pais = '"+self.pais+"', idEquipo_Campeon = "+str(self.campeon)+", Terminada= "+str(self.terminada)+", Año = '"+str(self.anio)+"' where idLiga = '"+str(self.id)+"';")
